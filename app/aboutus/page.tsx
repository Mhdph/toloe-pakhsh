      ...
      <div className='mt-6 px-4'>
        ...
        <div className='flex flex-col md:items-center'>
          ...
          <p className='text-xs font-normal text-black-items md:w-1/2 md:text-center md:text-[14px]'>
            بنکداری آنلاین طلوع پخش با تکیه بر ۲۰ سال سابقه فعالیت در حوزه تولید و پخش مواد غذایی٬اولین بنکداری آنلاین
            در ایران را راه اندازی کرده است تا شما عزیزان بتوانید محصولات با کیفیت را با قیمت عمده تهیه کنید. هرروز دسته
