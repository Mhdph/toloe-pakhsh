...
export const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-3xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-[#f6622c] from-10% via-[#f55330] via-30% to-[#f02d3c] to-90% text-primary-foreground bg-gradient-to-r from-[#f6622c] from-10% via-[#f55330] via-30% to-[#f02d3c] to-90%',
        destructive: 'bg-white text-black hover:bg-white/70',
        outline: 'border border-main-red text-main-red bg-background  hover:text-accent-foreground',
...
const Button = React.forwardRef<HTMLButtonElement, ButttonProps>(
